...
const Contact = () => {
  ...
  return (
      <motion.div className="contact" variants={variants} initial="initial" whileInView="animate">
          ...
          <svg width="800px" height="485px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <motion.path
              ...
              <motion.form ref={formRef} onSubmit={sendEmail} initial={{opacity:0}} whileInView={{opacity:1}} transition={{delay:2.6, duration:1}}>
